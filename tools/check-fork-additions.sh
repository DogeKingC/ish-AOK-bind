...
need_file tests/manual/arm64/parked_wait_store.c
need_in fs/aok-tests.manifest             arm64/parked_wait_store.c
need_in tests/manual/setup-regressions.sh parked_wait_store
